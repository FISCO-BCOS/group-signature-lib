...
ExternalProject_Add(pbc_sig
    ...
    LOG_BUILD 1
    LOG_INSTALL 1
    INSTALL_COMMAND bash -c "/bin/cp -f libpbc_sig.a ${CMAKE_SOURCE_DIR}/deps/lib/libpbc_sig.a"
)
...
set(PBC_SIG_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/deps/include)
set(PBC_SIG_LIBRARY ${CMAKE_SOURCE_DIR}/lib/libpbc_sig.a)
file(MAKE_DIRECTORY ${PBC_SIG_INCLUDE_DIR})  # Must exist.
file(MAKE_DIRECTORY ${CMAKE_SOURCE_DIR}/lib)  # Must exist.
